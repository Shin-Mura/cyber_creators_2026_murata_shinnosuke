...
void Square::Update()
{
	...
	pVtx[0].pos = { pos.x - (size.x / 2), pos.y - (size.y / 2), 0.0f };
	pVtx[1].pos = { pos.x + (size.x / 2), pos.y - (size.y / 2), 0.0f };
	pVtx[2].pos = { pos.x - (size.x / 2), pos.y + (size.y / 2), 0.0f };
	pVtx[3].pos = { pos.x + (size.x / 2), pos.y + (size.y / 2), 0.0f };
